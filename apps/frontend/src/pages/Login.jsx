...
const Login = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-8rem)] md:min-h-[calc(100vh-9rem)] px-4 py-8"> {/* Adjusted min-height for navbar */}
                    ...
                    <form onSubmit={handleSubmit} className="grid gap-4">
                        ...
                        {error && (
                            <Alert variant="destructive" className="bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-700/50">
                                ...
                                <AlertTitle className="text-red-700 dark:text-red-300">Login Failed</AlertTitle>
